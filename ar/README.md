...
تم نقل جميع المواد الرسومية، لقطات شاشة التثبيت، إعدادات الطرفية (Terminal) خطوة بخطوة، وإعدادات الواجهة الرسومية (GUI) خارج النص الرئيسي إلى دليل معزول باسم `/images`. تم تنظيم الرسومات في مجلدات فرعية، مما يمنع تماماً معالجتها تلقائياً في الذاكرة أثناء قراءة الكتاب.
