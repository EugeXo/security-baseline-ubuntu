...
4. **Аппаратный и криптографический контроль:** Интеграция YubiKey (TTY/GUI), скрытые контейнеры VeraCrypt, песочницы Firejail, Bubblewrap, изоляция Docker и VirtualBox.
