...
Все графические материалы, скриншоты установки, настройки GUI вынесены за пределы основного текста в изолированную директорию `_assets/images`. Графика структурирована по подпапкам, что полностью исключает её автоматический рендеринг в памяти в процессе чтения книги. Добавлены стилистические иконки `_assets/icons` содержащая подпапки `256x256`; `256x256@2x`, и подпапка `Trash` внутри которой так же находятся подпапки для стилистических иконок корзины. Так же в `_assets/wallpapers` стилистические обои по подпапкам.
