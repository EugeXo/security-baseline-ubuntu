...
Все графические материалы, скриншоты установки, пошаговые конфиги терминала и настройки GUI вынесены за пределы основного текста в изолированную директорию `/images`. Графика структурирована по подпапкам, что полностью исключает её автоматический рендеринг в памяти в процессе чтения книги.
