...
کتاب پڑھنے کے دوران میموری میں گرافکس فائلز کے خودکار طور پر رینڈر (لوڈ) ہونے کو مکمل طور پر روکنے کے لیے، تمام گرافیکل مواد، انسٹالیشن اسکرین شاٹس اور GUI کنفیگریشنز کو بنیادی متن سے الگ ایک محفوظ ڈائریکٹری `_assets/images` میں منتقل کر دیا گیا ہے۔ گرافکس کو ذیلی فولڈرز (subfolders) میں ترتیب دیا گیا ہے۔ اس کے علاوہ `_assets/icons` ڈائریکٹری میں اسٹائلش آئیکنز شامل کیے گئے ہیں، جس میں `256x256` اور `256x256@2x` کے ذیلی فولڈرز اور ایک `Trash` نامی ذیلی فولڈر شامل ہے (جس کے اندر ری سائیکل بن کے آئیکنز کے لیے مزید ذیلی فولڈرز موجود ہیں)۔ اسی طرح `_assets/wallpapers` میں اسٹائلش وال پیپرز بھی ذیلی فولڈرز میں تقسیم کر کے رکھے گئے ہیں۔
---
